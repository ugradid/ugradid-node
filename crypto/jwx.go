...
import (
	...
	"github.com/ugradid/ugradid-node/crypto/storage"
)

// ErrUnsupportedSigningKey is returned when an unsupported private key is used to sign.
//Currently only ecdsa and rsa keys are supported
...
//The headers param can be used to add additional headers
...
// Thumbprint generates a compatible thumbprint: Base58(SHA256(rfc7638-json))
