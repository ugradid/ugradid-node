...
// Publisher defines the interface for types that publish transactions.
...
//Taken from https://stackoverflow.com/questions/25065055/what-is-the-maximum-time-time-in-go
